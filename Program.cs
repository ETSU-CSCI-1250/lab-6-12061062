...
ShowCharacter(city);
static void ShowCharacter(string city, int x = 1)
{
    Console.WriteLine($"The letter in the second index of {city} is {city[x]}.");
}
...
static void Celsius()
{
    ...
    Console.WriteLine(" The conversion from fahrenheit to celsius 80 - 100 degrees:");
